...
with open('artifacts/scaler_young.pkl', 'rb') as f:
    scaler_young = pickle.load(f)
with open('artifacts/scaler_rest.pkl', 'rb') as f:
    scaler_rest = pickle.load(f)

with open('artifacts/model_young.pkl', 'rb') as f:
    model_young = pickle.load(f)
with open('artifacts/model_rest.pkl', 'rb') as f:
